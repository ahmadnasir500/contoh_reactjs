...
const RegisterPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      registerUserWithEmailAndPassword(form.email, form.password);
    }
  };
  useEffect(() => {
    if (user) {
  ...
  return (
    <>
      ...
      <Link to={"/"}>
        ...
        <h3 className="text-center fw-bold text-white">Start explore Moon Stars</h3>
            ...
            <Row className="mb-3">
              <Form.Group as={Col} lg="12" controlId="name" className="mb-3">
                ...
                <Form.Control
                  ...
                  className="rounded-quran input-background"
